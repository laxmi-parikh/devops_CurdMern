...
/** @public */
export declare type AuthFlowType = 'auth-code' | 'device-auth';
 ...
 * @public
 */
export declare interface DeviceFlowInformation {
...
export declare class MongoDBOIDCError extends Error {
    /* Excluded from this release type: [MongoDBOIDCErrorTag] */
...
/** @public */
export declare interface MongoDBOIDCPlugin {
    /**
...
/** @public */
export declare interface OpenBrowserOptions {
    /**
...
/** @public */
export declare type OpenBrowserReturnType = void | undefined | (TypedEventEmitter<{
...
/** @public */
export declare type RedirectServerRequestHandler = (data: RedirectServerRequestInfo) => void;

/** @public */
export declare type RedirectServerRequestInfo = {
...
/** @public */
export declare interface TypedEventEmitter<EventMap extends object> {
